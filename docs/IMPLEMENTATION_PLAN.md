...
- **Status:** in progress — WP-P0.4 merged (Phase P0).
...
| P0.1 Honest, size-aware gate | next | `phase/p0.1-gate-honesty` |
| P0.2 Atomic plan/funding | pending | — |
| P0.3 Constraints in the prompt | pending | — |
| P0.6 Sentiment once | pending | — |
